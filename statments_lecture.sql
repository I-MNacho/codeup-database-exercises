...
VALUES ('Casey', 'Edwards', 'To be or not to be.');


INSERT INTO quotes (author_first_name, author_last_name, content)       #number of columns and their value in order
VALUES ('Justin', 'Reich', 'Do your best while you can.');

# Viewing all records on a table, sets an ID automatically
SELECT * FROM quotes;

# Inserting Multiple Records
INSERT INTO quotes (author_first_name, author_last_name, content)
    VALUES  #strings are wrapped in single quotes, if quotes wanted in display use single quotes again '' ''
...
# Inserting strings with escaped quotes
    #strings are wrapped in single quotes, if quotes wanted in display use single quotes again '' ''
