...
# Authors TABLE (owning side of tables, usually the one that uses the keys)
# id
# first_name
# last_name
# pen_name
# DOB
# genre
# author_contact_info_id FK (foreign key)
# # ==================================================
# #this table is 'owned' by the above table
# Author_contact_info TABLE
# id
# phone_number
# email_address
# mailing_address
...
# ==================================================
#One-to-Many Relationship
#the many side always has a FK that points to the One side

# TABLE: Users (ONE SIDE)
# id
# username
# password
# first_name
...
# user_id FK
#
# SELECT u.username, e.email_address FROM users AS u
