...
SELECT hire_date, COUNT(*) AS 'No of employees hired' FROM employees
GROUP BY hire_date
ORDER BY COUNT(*) DESC;


SELECT * FROM salaries;
#How many salaries aer at a given amount?
#61400 salary

SELECT salary,COUNT(*)AS `No of Employees with the same salary` FROM salaries
group by salary
ORDER BY COUNT(*) DESC;
...
#Order by first and then last name
SELECT first_name, last_name FROM employees
GROUP BY first_name, last_name;

#Filter out just unique names
